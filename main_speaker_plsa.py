...
parser.add_argument('--save', type=str,  default='model_spk_plsa.pt',
...
model = model_speaker_plsa.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, pzd.shape[1], args.dropout, args.tied)
if args.cuda:
    model.cuda()
